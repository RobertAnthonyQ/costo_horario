...
export const MachineForm: React.FC<MachineFormProps> = ({
  ...
  const handleAdditionalDataChange = (field: keyof DatosAdicionalesMaquina, value: any) => {
    setFormData((prev) => ({
      ...prev,
      datos_adicionales: {
  ...
  const handleAdditionalDataNumberChange = (field: keyof DatosAdicionalesMaquina, value: string) => {
    const numValue = value === "" ? undefined : Number(value);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const hasAdditionalData = formData.datos_adicionales && Object.values(formData.datos_adicionales).some(value => 
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <Label htmlFor="informacion_adicional">Información Adicional (JSON)</Label>
        <Textarea
        ...
        />
        <p className="text-xs text-muted-foreground">
          Campo legacy. Se recomienda usar los "Datos Adicionales Estructurados" a continuación.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        {showAdditionalData && (
          ...
          <div className="border rounded-lg p-4 bg-muted/10">
            <div className="mb-4">
              <h4 className="text-sm font-medium">Información Técnica y Comercial</h4>
              <p className="text-xs text-muted-foreground">
                Datos estructurados sobre especificaciones técnicas, comerciales y de servicio
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleAdditionalDataChange("procedencia_pais", e.target.value)
                  }
              ...
              {/* Potencia Nominal */}
              <div className="space-y-2">
                <Label htmlFor="potencia_nominal_hp">Potencia Nominal (HP)</Label>
                <Input
                  id="potencia_nominal_hp"
                  type="number"
                  min="0"
                  value={formData.datos_adicionales?.potencia_nominal_hp ?? ""}
                  onChange={(e) =>
                    handleAdditionalDataNumberChange("potencia_nominal_hp", e.target.value)
                  }
                  placeholder="Ej: 200"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="consumo_combustible_lh">Consumo Combustible (L/h)</Label>
                <Input
                  id="consumo_combustible_lh"
                  type="number"
                  min="0"
                  step="0.1"
                  value={formData.datos_adicionales?.consumo_combustible_lh ?? ""}
                  onChange={(e) =>
                    handleAdditionalDataNumberChange("consumo_combustible_lh", e.target.value)
                  }
                  placeholder="Ej: 15.5"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="equipos_comercializados_peru">Equipos en Perú</Label>
                <Input
                  id="equipos_comercializados_peru"
                  type="number"
                  min="0"
                  value={formData.datos_adicionales?.equipos_comercializados_peru ?? ""}
                  onChange={(e) =>
                    handleAdditionalDataNumberChange("equipos_comercializados_peru", e.target.value)
                  }
                  placeholder="Ej: 150"
                />
              </div>
              ...
              {/* Plazo de Entrega */}
              <div className="space-y-2">
                <Label htmlFor="plazo_entrega_dias">Plazo Entrega (días)</Label>
                <Input
                  ...
                  onChange={(e) =>
                    handleAdditionalDataNumberChange("plazo_entrega_dias", e.target.value)
                  }
                  placeholder="Ej: 45"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="capacitacion_horas">Capacitación (horas)</Label>
                <Input
                  ...
                  onChange={(e) =>
                    handleAdditionalDataNumberChange("capacitacion_horas", e.target.value)
                  }
                  placeholder="Ej: 40"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="tiempo_atencion_repuestos_dias">Atención Repuestos (días)</Label>
                <Input
                  id="tiempo_atencion_repuestos_dias"
                  type="number"
                  min="0"
                  value={formData.datos_adicionales?.tiempo_atencion_repuestos_dias ?? ""}
                  onChange={(e) =>
                    handleAdditionalDataNumberChange("tiempo_atencion_repuestos_dias", e.target.value)
                  }
                  placeholder="Ej: 7"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="ofrece_financiamiento">Ofrece Financiamiento</Label>
                <Select
                  value={formData.datos_adicionales?.ofrece_financiamiento?.toString() || "false"}
                  onValueChange={(value) =>
                    handleAdditionalDataChange("ofrece_financiamiento", value === "true")
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
